...
class _DetailCache:
    def __init__(self):
        # Use /tmp for Vercel compatibility (only writable dir in serverless)
        _base = Path("/tmp") if os.path.exists("/tmp") else Path.home() / ".cache"
        self.dir = _base / "tax-policy-search"
